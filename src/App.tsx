...
type Route = 'home' | 'assessment' | 'report' | 'ledger' | 'expenses' | 'plan' | 'education' | 'insurance' | 'interest_class' | 'advisor' | 'pocket_money' | 'profile' | 'high_value';

const routes: Route[] = ['home', 'assessment', 'report', 'ledger', 'expenses', 'plan', 'education', 'insurance', 'interest_class', 'advisor', 'pocket_money', 'profile', 'high_value'];
